...
const FavoritesPage = React.lazy(
  () =>
    import(
      /* webpackChunkName: "FavoritesPage" */ '../pages/FavoritesPage/FavoritesPage'
    ),
)
const CategoryPage = React.lazy(
  () =>
    import(
      /* webpackChunkName: "CategoryPage" */ '../pages/CategoryPage/CategoryPage'
    ),
)
...
const AllProductsPage = React.lazy(
  () =>
    import(
      /* webpackChunkName: "AllProductsPage" */ '../pages/AllProductsPage/AllProductsPage.js'
    ),
)
...
const PrivacyPage = React.lazy(
  () =>
    import(
      /* webpackChunkName: "PrivacyPage" */ '../pages/PrivacyPage/PrivacyPage'
    ),
)
